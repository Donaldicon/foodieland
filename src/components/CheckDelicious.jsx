...
const CheckDelicious = () => {
  ...
  return (
    ...
    viewport={{ once: true }}
    >
      <section className='pt-[70px] pb-[50px] px-[5%] bigScreens:px-[13%] font-Inter flex flex-col items-center justify-center dark:text-gray-200'>
          ...
          <div className="grid grid-cols-4 gap-16 bigScreens:gap-20 mt-10">
                      {images.map((image) => (
                      <div key={image.id} className="w-full relative">
                          ...
                          <div className="flex items-center space-x-6 mt-5 ">
                              ...
                              <FontAwesomeIcon icon={faClock} className="bg-black text-white rounded-full text-[18px] dark:text-gray-300 bigScreens:text-[25px]" />
                              ...
                              <div className="text-[12px] flex items-center space-x-2  bigScreens:text-[18px]">
                                  <FontAwesomeIcon icon={faCutlery} className="text-black dark:text-gray-300 rounded-full text-[18px]  bigScreens:text-[25px] " />
