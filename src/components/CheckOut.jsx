...
const CheckOut = () => {
  return (
        <section className="bg-gradient-to-b from-[#E7F9FD00] to-[#E7F9FD] mt-10 pb-20 px-[5%] bigScreens:px-[13%] font-Inter flex flex-col items-center justify-center text-black dark:text-gray-200">
            ...
            <div className='text-white bg-black rounded-xl px-10 py-4 text-[12px] bigScreens:text-[15px] mt-12 xl:mt-16 cursor-pointer hover:bg-opacity-20 hover:text-black transition-all ease-in-out duration-500 flex items-center space-x-1'>
