    ...
    >
        <section className='px-[5%] bigScreens:px-[13%] mt-20 w-full flex items-center justify-center font-Inter'>
            <div className='flex flex-col items-start w-[45%] text-[14px] xl:text-[17px] bigScreens:text-[20px] pr-[5%]'>
                <h1 className='text-[30px] leading-[35px] xl:text-[45px] xl:leading-[55px] bigScreens:text-[55px] bigScreens:leading-[65px] font-semibold'>Everyone can be a <br></br> chef in their own kitchen</h1>
                <p className='pr-[5%] mt-5 text-black text-opacity-[50%]'>Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </p>
                <Link to='/Recipes'>
